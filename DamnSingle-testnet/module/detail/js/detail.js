    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            switch (data.msg.state) {
                case 9:
                    text = nextJson(LText.Title, LText.SendOrderFaild, 1, [LText.Ok], [OK]);
                    break;
                case 100:
                    text = nextJson(LText.Title, LText.SendSuc, 1, [LText.Ok], [closeBuyView]);
                    break;
            }
            promptText(text);
            destory();
...
var kitty_status = function (data) {
    ...
    if (!data.is_ready) { //---0 ---
        ...
        if (!data.is_gestating) { //---00---
            ...
            if (!isNull(data.left_cooldown)) { return; }
        ...
        default:
            ...
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    url = "url(./module/detail/img/coatcolor.svg)";
                    break;
                case 2:
                    url = "url(./module/detail/img/brain.svg)";
                    break;
