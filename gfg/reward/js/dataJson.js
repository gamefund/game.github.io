    ...
    cn: [
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的10%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "成功加入可获得5个GF；",
                            "用户根据活跃评级可获得相应的额外GF奖励：<br/>不活跃可获得0个GF；<br/>达到一般活跃评级可获得10个GF；<br/>达到积极用户评级可获得20个GF；<br/>达到激情用户评级可获得35个GF；<br/>达到狂热用户评级可获得50个GF。"],
            ...
            // },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的15%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "关注GAME.FUND官推可获得5个GF。",
                            "30人以下关注者，每次转推获得1个GF；<br/>31-100关注者，每次转推获得10个GF；<br/>101-500关注者，每次转推获得50个GF；<br/>501-1000关注者，每次转推获得100个GF；<br/>1001-3000关注者，每次转推获得300个GF；<br/>3000人以上关注者，每次转推获得500个GF。"],
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的30%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "获得GF的数量由作品内容的质量决定（文章经过官方审查后确定质量评级）。<br/>拒绝：获得0个GF；<br/>普通：获得1500个GF；<br/>优良：获得5000个GF；<br/>卓越：获得9000个GF。",
                            "文章被官方转载可以获得额外的GF。<br/>普通：获得1000个GF；<br/>优良：获得1500个GF；<br/>卓越：获得2000个GF。"],
                    ...
                    rule: ["用户的博客或论坛账号的开通时长需要大于2个月。",
                        "文章内容需要有价值并且与GAME.FUND相关，如：白皮书的各方面内容、交易服务、GF升值前景、技术相关等。",
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的10%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "关注GAME.FUND官方频道可获得5个GF。",
                            "获得GF的数量由作品的质量决定（视频经过审查后由官方决定质量评级）。<br/>拒绝：获得0个GF；<br/>普通：获得5000个GF；<br/>优良：获得15000个GF；<br/>卓越：获得30000个GF。",
                            "视频被官方转载可以获得额外的GF。<br/>普通：获得1500个GF；<br/>优良：获得3000个GF；<br/>卓越：获得5000个GF。"],         
            ...
            /*{
                ...
                content: {
                    ...
                    award: ["赏金总额的5%将作为此任务的赏金奖励给所有符合条件的任务参与者。",          
                            "白皮书翻译获得GF的数量由译文的质量决定（译文经过审查后由官方决定质量评级）。<br/>较差：获得0个GF；<br/>普通：获得2000个GF；<br/>良好：获得3000个GF；<br/>优秀：获得4000个GF。",
                            "白皮书翻译如同时有多个任务参与者并且最终都完成了翻译任务，则最终官方采用译文的翻译者将额外获得100个GF。",
                            "文案翻译获得GF的数量由译文的质量决定（译文经过审核后由官方决定质量评级）。<br/>较差：获得0个GF；<br/>普通：获得100个GF；<br/>良好：获得200个GF；<br/>优秀：获得300个GF。",
                            "审核白皮书译文单个语种单篇可获得200个GF；<br/>审核文案单个语种单篇可获得50个GF。",],         
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的5%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            "每成功邀请一个用户注册GAME.FUND账号可获得2个GF奖励。",
                            "每成功邀请一个用户注册GAME.FUND账号并且加入GAME.FUND电报群可再获得3个GF奖励。",
                            "每成功邀请一个用户并且通过了KYC审核可获得20个GF奖励。"],
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["赏金总额的15%将作为此任务的赏金奖励给所有符合条件的任务参与者。",
                            ...
                            "每成功邀请一个用户注册GAME.FUND账号并且加入GAME.FUND电报群可再获得3个GF奖励。",
                            "每成功邀请一个用户并且通过了KYC审核可获得20个GF奖励。",
                            "通过个人邀请码被邀请的用户完成注册将和您建立管道关系。您邀请的用户再通过他本人的邀请码所邀请的用户也可以和您建立管道关系，依此类推您最多可建立3层管道关系，即：您——>您邀请的用户A（A为群组，指您邀请的所有用户）——>A邀请的用户B（B为群组，指A群组内用户所邀请的所有用户）——>B邀请的用户C（C为群组，指B群组内用户所邀请的所有用户）。建立管道后，您所建立的管道内用户如果购买GF币，您将获得奖励。奖励额度为：<br/>A购买GF总量的4%；<br/>B购买GF总量的0.7%；<br/>C购买GF总量的0.3%。",
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["10% of total sum of the bounty will be paid to task participants that are eligible for the task.",
                            "You can get 5 GF if you successfully join the group.",
                            'Additional GF reward can be given according to different active level of users.<br/>You can get 0 GF if you are rated as "Not Active"<br/>You can get 10 GF if you are rated as "General Active User".<br/>You can get 20 GF if you are rated as "Active User".<br/>You can get 35 GF if you are rated as "Passionate User".<br/>You can get 50 GF if you are rated as "Avid User".'],
            ...
            /*{
                ...
                content: {
                    ...
                    award: ["5% of total sum of the bounty will be paid to task participants that are eligible for the task. ",
                            "You can get 100 GF if you pass Know-your-customer review."],
                
                    join: ["Register a GAME.FUND ID successfully and pass Know-your-customer review.",
                            "After passing the review, the system will send 100 GF reward to your bound wallet automatically."],
            ...
            }, */
            {
                ...
                content: {
                    ...
                    award: [" 15% of total sum of the bounty will be paid to task participants that are eligible for this task . ",
                            "Follow GAME.FUND official Twitter and you will get 5 GF.",
                            " If you have less than 30 followers, you can get 1 GF by retweeting  one of our tweets.<br/>If you have 30-100 followers, you can get 10 GF by retweeting  one of our tweets.<br/>If you have 101-500 followers, you can get 50 GF by retweeting  one of our tweets.<br/>If you have 501-1000 followers, you can get 100 GF by retweeting  one of our tweets.<br/>If you have 1001-3000 followers, you can get 300 GF by retweeting  one of our tweets.<br/>If you have more than 3000 followers, you can get 500 GF by retweeting  one of our tweets."],
                    //##
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["30% of total sum of the bounty will be paid to task participants that are eligible for this task . .",
                            'Reward quantity of GF will be decided by the quality of the article.(The official authority will review and rate article grade .)<br/>You will get 0 GF if your article is rated as "Rejected".<br/>You will get 1500 GF if your article is rated as "Average".<br/>You will get 5000 GF if your article is rated as "Good".<br/>You will get 9000 GF if your article is rated as "Excellent".',
                            'Additional GF can be given if your article is forwarded by the official authority. Details is as below: <br/>You will get 1000 GF if your article is rated as "Average".<br/>You will get 1500 GF if your article is rated as "Good".<br/>You will get 2000 GF if your article is rated as "Excellent".'],
                    ...
                    rule: ["Your Blog or BBS ID must have been valid for at least two months.",
                        "The article content must be of value and related to GAME.FUND. The topics include : GF appreciation,content included in white paper, transaction service,technical related issues, etc.",
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["10% of total sum of the bounty will be paid to task participants that are eligible for this task.",
                            'You can get 5 GF if you follow "GAME.FUND" official channel',
                            'How many GF you can get depends on content quality of the videos. Video quality rating will be decided by the authority.<br/>If your video is rated as "Rejected", you can get 0 GF.<br/> If your video is rated as "Common",you can get 5000 GF.<br/>If your video is rated as "Good", you can get 15000 GF.<br/>If your video is rated as "Excellent", you can get 30000 GF. ',
                            'If your video is forwarded by an official authority, you can get additional GF.Details is as below:<br/>If your video is rated as "Common" , you can get 1500 GF.<br/>If your video is rated as "Good" , you can get 3000 GF. <br/>If your video is rated as "Excellent" , you can get 5000 GF.'],         
            ...
            /*{
                ...
                content: {
                    ...
                    award: ["5% of total sum of the bounty will be paid to task participants that are eligible.",          
                            'Reward quantity of GF from white paper translation will be decided by the quality of the translation (The translation will be rated by the official authority after review.)<br/>If your translation is rated as "Poor",you will get 0 GF. <br/>If your translation is rated as "Average",you will get 2000 GF.<br/>If your translation is rated as "Good", you will get 3000 GF.<br/>If your translation is rated as "Excellent", you will get 4000 GF. ',
                            "If many participants participate in the translation of white paper and all finish the task,the translator whose translation is adopted by the official authority will get additional 100 GF.",
                            'Reward quantity of GF from copywriting translation will be decided by the translation quality (The translation will be rated by the official authority after review.)<br/>If your translation is rated as "Poor",you will get 0 GF.<br/>If your translation is rated as "Average",you will get 100 GF.<br/>If your translation is rated as "Good", you will get 200 GF.<br/>If your translation is rated as "Excellent", you will get 300 GF .',
                            "You can get 200 GF if you review and verify monolingual white paper translation.<br/>You can get 50 GF if you review and verify monolingual copywriting translation.",],         
            ...
            },
            {
                ...
                content: {
                    ...
                    award: ["5% of total sum of the bounty will be paid to task participants that are eligible for this task . ",
                            "You will get 2 GF as a reward after you invite one user to register a GAME.FUND ID successfully.",
                            "You will get 3 GF as a reward after you invite one user to register a GAME.FUND ID successfully and to join our telegram group successfully. ",
                            "You will get 20 GF as a reward after you invite one user and this user pass KYC review successfully."],
