...
var headerInit = function () {
     ...
     * 点击进入游戏
     */
    $(".kitties-game").click(function(){
        //showGameHeaderLine();
        var text = nextJson(LText.Title, LText.GameTip, 1, [LText.Ok], [OK]);
        promptText(text);

        //  onclick="competitionInit()"
    })

    //返回按钮
    $(".header-return").click(backFunction);
...
//导航栏的选中game显示下划线
var showGameHeaderLine = function () {
    $(".kitties-game").addClass("kitty-header-selected").siblings().removeClass("kitty-header-selected");
}
